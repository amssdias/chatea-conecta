...
from apps.subscriptions.webhook_handlers.invoices import handle_invoice_paid, handle_invoice_payment_failed
...
STRIPE_EVENT_HANDLERS = {
    ...
    StripeEventType.CUSTOMER_SUBSCRIPTION_UPDATED: handle_customer_subscription_updated,
